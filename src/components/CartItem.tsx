...
type CartItemProps =  { id: string, title: string, type: string, size: number,  price: number, count: number, image: string} 


export const CartItem: React.FC<CartItemProps> = ({id, title, type, size,  price, count, image}) => {
